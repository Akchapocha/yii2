...
class CouriersController extends AppController
{
    ...
    /**
     * Экшн для отображения списка звонков курьеров
     *
     * @return string
     */
    public function actionIndex()
    {
        ...
        $this->view->registerCssFile('@web/css/couriers.css', ['depends' => 'app\assets\AppAsset']);
        $this->view->registerJsFile('@web/js/couriers.js', ['depends' => 'yii\web\YiiAsset']);
    ...
    /**
     * Экшн для отображения списка вызовов курьеров при применении фильтра
     *
     * @return string
     */
    public function actionShow()
    {
        ...
        if (isset($_POST['_csrf'])) {
            ...
            if (Yii::$app->request->getCsrfTokenFromHeader() === $_POST['_csrf']) {
                ...
                $model = New Cdr();
                $calls = $model->getCouriersCalls($_POST);
